  ...
  return (
    knex.schema
      ...
      .createTable("user_profile", tbl => {
        ...
        tbl.string("image", 500);
        tbl.string("bio", 1000);
        tbl.string("facebookLink", 500);
        tbl.string("githubLink", 500);
        tbl.string("discordLink", 500);
        tbl.string("twitterLink", 500);
        tbl.string("linkedInLink", 500);
        tbl.string("externalEdLink", 500);
      })
      ...
      //FYI in terms of naming interests is synonymous with the tags table
      //interest is on myProfile.jsx in the frontend
      .createTable("users_interests", tbl => {
        tbl.increments();
        tbl
          .integer("user_id")
          .unsigned()
